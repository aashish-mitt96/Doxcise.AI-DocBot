          ...
          <div className="relative z-10">
            <div className="mb-4">
              ...
              <h1 className="text-4xl font-extrabold tracking-tight leading-tight mb-4 bg-gradient-to-r from-white to-cyan-300 bg-clip-text text-transparent">
                Welcome Back to <span className="text-cyan-300">Doxcise.AI</span>
              </h1>

              <p className="text-lg text-gray-200 leading-relaxed mb-6">
                Continue your AI journey with lightning-fast tools and intelligent templates.
              </p>
            </div>
            ...
            <div className="space-y-3 mb-6">
              <div className="flex items-center text-gray-300 text-sm">
                ...
                <span>Real-time smart editor</span>
              </div>
              <div className="flex items-center text-gray-300 text-sm">
                <div className="w-1.5 h-1.5 bg-cyan-400 rounded-full mr-3"></div>
        ...
        <div className="p-6 sm:p-8 bg-black/40 text-white flex flex-col justify-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="mb-6 text-center">
              <div className="inline-flex items-center justify-center w-32 h-12  mb-4 shadow-lg">
                <img src="/logo.svg" alt="Genify Logo" className="h-14 w-26" />
              </div>
